...
import { Book, Code, FileText, Home, ExternalLink, ChevronRight } from "lucide-react";

export default function DocsPage() {
  const documentationSections = [
    {
      title: "User Manual",
      description: "Step-by-step guides with screenshots for using the POS system",
      icon: Book,
  ...
  const quickLinks = [
    { title: "Getting Started", href: "/docs/manual/index.html#/cover", icon: FileText },
      ...
      <main className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-300 max-w-3xl mx-auto">
            Everything you need to know about using and integrating with the
        ...
        <div className="bg-slate-800/30 rounded-2xl border border-slate-700 p-8">
          ...
          <div className="grid md:grid-cols-2 gap-6 text-slate-300">
            <div>
              <h4 className="font-semibold text-amber-500 mb-2">User Manual</h4>
              <p className="text-sm">
                The user manual is generated using{" "}
                <span className="text-amber-400">auto-docs</span> with
                screenshots captured from the live application. It provides
                visual guides for all user roles including customers, cashiers,
            ...
            <div>
              ...
              <p className="text-sm">
                ...
                <span className="text-amber-400">TypeDoc</span> from JSDoc
                comments in the source code. It covers all API endpoints,
                service functions, database schemas, and TypeScript type
                definitions.
              </p>
            </div>
          </div>
        ...
        <div className="mt-8 p-6 bg-slate-800/30 rounded-xl border border-slate-700">
          ...
          <p className="text-slate-400 text-sm mb-4">
            To regenerate the documentation after code changes, run the following commands:
          </p>
          <div className="bg-slate-900 rounded-lg p-4 font-mono text-sm">
            <p className="text-green-400"># Generate API documentation only</p>
            <p className="text-slate-300 mb-2">npm run docs:api</p>
            <p className="text-green-400"># Generate user manual (requires running app)</p>
            <p className="text-slate-300 mb-2">npm run docs:manual</p>
            <p className="text-green-400"># Generate all documentation</p>
