...
**Test Cases:**
- ✅ Success: Returns array of cooked items
...
**Test Cases:**
- ✅ Success: Creates cooked item with valid data
      ...
      "meals": [
        {
          ...
          "price": 8.99,
          "selections": {
            "entrees": [{"recipeId": 5, "recipeName": "Chicken Nuggets"}],
